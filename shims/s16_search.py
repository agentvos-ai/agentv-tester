...
class SearchShim(BaseShim):
        ...
        self._state["web"] = [
            {
                ...
                "snippet": "Recent analysis shows...",
                "url": "https://market-news.com/trends",
            }
        ]
        self._state["enterprise"] = [
            {
                "title": "Internal IT Policy",
                "snippet": "All employees must use...",
                "url": "local://it-policy",
            }
        ]
        self._state["news"] = [
            {
                "title": "Breaking: Tech Giant Acquires AI Startup",
                "snippet": "The acquisition aims to...",
    ...
    def _search_collection(self, collection: str, query: str) -> List[Dict[str, str]]:
        ...
        return [
            ...
            or query.lower() in d["snippet"].lower()
        ]
    ...
    def get_tool_specs(self) -> List[Tuple[str, Any, str]]:
        return [
            ...
            (
                ...
                "Search internal company documents and intranets.",
            ),
