...
from core.registry import (
    register_llm, get_llm_provider, 
    register_framework, get_framework_adapter,
    register_agent, get_agent_class,
    list_llms, list_agents, list_frameworks
)
from core.errors import ConfigError, AgentExecutionError
...
def test_base_agent_execution(mock_config, mock_llm, shim_registry):
    ...
    task = {"task_id": "T1", "input": "Check this fraud case", "context": {"priority": "high"}}
