...
class SuiteModelClient:
    ...
    @staticmethod
    def get_common_config_list(config_list: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        return config_list
...
class AG2Adapter(BaseFrameworkAdapter):
    ...
    def build_agent(self, system_prompt: str) -> RunnableAgent:
        ...
        assistant.register_model_client(model_client_cls=SuiteModelClient, llm=self.llm, config=self.config.llm)
